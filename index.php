...
<body id="home">
   ...
   <section class="home">
      ...
      <div class="content">
         <h3>15% DE RÈDUCTION SUR VOTRE COMMANDE!</h3>
         <a href="about.php" class="white-btn">découvrez Maintenant</a>
      </div>
      ...
      <div class="box-container">
         ...
         ?>
               <form action="" method="post" class="box">
                  ...
                  <div class="price"><?php echo $fetch_products['price']; ?>/- MAD</div>
   ...
   <section class="home-contact">
      ...
      <div class="content">
         ...
         <a href="contact.php" class="white-btn">découvrez Maintenant</a>
      </div>
